...
public class StreamUtilTest {
    ...
    @Test
    public void testToMapByStream() {
        Collection<Product> products = generateList();
        Map<String, Product> productMap = products.stream().collect(Collectors.toMap(Product::getProductCode,
